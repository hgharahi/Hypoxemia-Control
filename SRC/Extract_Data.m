...
%     Data.Flow = Data.Flow(end-tstep_from_end:end);
    ...
    tstep_start = idx_t_off - ceil(2/dt); %% sets the index of the first point that we want to consider: 7 seconds after clamping the circuit. (7 can be adjusted!)       
